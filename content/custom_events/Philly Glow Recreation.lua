...
function onCreate()
	...
	setProperty('phillyGlowBlack.alpha', 0.5)
	addLuaSprite('phillyGlowBlack', true)
	
	makeLuaSprite('phillyGlowGradient', 'philly/gradient', -400, 150)
	setGraphicSize('phillyGlowGradient', 5000, 400)
	...
	makeLuaSprite('phillyWindowEvent', 'philly/window', -1085, -506)
...
function updateOrder()
	...
	setObjectOrder('gfGroup', 100000)
	setObjectOrder('dadGroup', 100001)
	setObjectOrder('boyfriendGroup', 100001)
