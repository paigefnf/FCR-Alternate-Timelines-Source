...
if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Duality Bullet Note' then --Check if the note on the chart is a Bullet Note
...
if type == 'Duality Bullet Note' then
