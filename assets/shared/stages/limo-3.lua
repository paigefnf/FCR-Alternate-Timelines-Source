function onCreate()
makeLuaSprite('sky','limo3/limoSky',-3200,-800)
setScrollFactor('sky',0.7,0.7)
addLuaSprite('sky')
    
makeLuaSprite('front','limo3/frontStreet',300,-200)
setScrollFactor('front',0.9,0.9)
screenCenter('front','x')
addLuaSprite('front')
    
makeLuaSprite('light1','limo3/streetLight',-500,-600)
addLuaSprite('light1')
    
makeLuaSprite('light2','limo3/streetLight',300,-600)
addLuaSprite('light2')
    
makeLuaSprite('light3','limo3/streetLight',1100,-600)
addLuaSprite('light3')
    
makeLuaSprite('light4','limo3/streetLight',1900,-600)
addLuaSprite('light4')
...
makeAnimatedLuaSprite('fog','limo3/funkerFog',-600,-600)
