function onCreate()
makeLuaSprite('bg','stage_assets/philly3/sky', -800, -1000);
setLuaSpriteScrollFactor('bg', 0.1, 0.1);		
makeLuaSprite('bg2','stage_assets/philly3/skyEclipse', -800, -1000);
...
makeLuaSprite('lightOverlay','stage_assets/philly3/lightOverlay', -1800, -400);
