function onCreate()
makeLuaSprite('sky','stage_assets/alley/alleySky',-200,-100)
setScrollFactor('sky',0.7,0.7)
addLuaSprite('sky', false)

makeLuaSprite('sky2','stage_assets/alley/alleySky2',-200,-100)
setScrollFactor('sky2',0.7,0.7)
setProperty('sky2.alpha',0)
addLuaSprite('sky2', false)

makeLuaSprite('mansion','stage_assets/alley/alleyFront',-350,-200)
