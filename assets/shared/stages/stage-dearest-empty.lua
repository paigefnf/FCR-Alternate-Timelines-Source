...
makeLuaSprite('shadow','stage_assets/shadowOverlay',0,0)
setObjectCamera('shadow','hud')
addLuaSprite('shadow',false)

makeLuaSprite('lay','stage_assets/overlay',0,0)
setObjectCamera('lay','hud')
setProperty('lay.visible',false)
addLuaSprite('lay')

makeLuaSprite('lay2','stage_assets/overlayLights',0,0)
