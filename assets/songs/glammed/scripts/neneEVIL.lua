...
idleoffsets = {'85', '20'} -- I recommend you have your idle offset at 0
leftoffsets = {'116', '16'}
downoffsets = {'96', '-34'}
upoffsets = {'18', '106'}
rightoffsets = {'38', '31'}
...
idle_xml_name = 'Nene Idle0'
right_xml_name = 'Nene Left0'
down_xml_name = 'Nene Down0'
up_xml_name = 'Nene Up0'
left_xml_name = 'Nene Right0'
...
name_of_character_xml = 'mother/definitive/nene_evil'
name_of_character = 'nene-evil-glammed'
name_of_notetype = 'neneNote'
