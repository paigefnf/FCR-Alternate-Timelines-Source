...
class FCRLimo extends BaseStage
{
	override function create()
	{
		...
		var light1:BGSprite = new BGSprite('stage_assets/limo/streetLight',-500,-300);
		add(light1);

		var light2:BGSprite = new BGSprite('stage_assets/limo/streetLight',300,-300);
		add(light2);

		var light3:BGSprite = new BGSprite('stage_assets/limo/streetLight',1000,-300);
		add(light3);

		var light4:BGSprite = new BGSprite('stage_assets/limo/streetLight',1900,-300);
		add(light4);

		var backCar:BGSprite = new BGSprite('stage_assets/limo/backCar',-100,280);
		add(backCar);
