...
class FCRLimo3 extends BaseStage
{
	override function create()
	{
		var sky:BGSprite = new BGSprite('stage_assets/limo3/limoSky',-3200,-800, 0.7, 0.7);
		add(sky);

		var front:BGSprite = new BGSprite('stage_assets/limo3/frontStreet',300,-200, 0.9, 0.9);
		add(front);
		...
		var backCar:BGSprite = new BGSprite('stage_assets/limo3/backCar',-300,50);
		add(backCar);

		var frontCar:BGSprite = new BGSprite('stage_assets/limo3/frontCar',-25,50);
		add(frontCar);
