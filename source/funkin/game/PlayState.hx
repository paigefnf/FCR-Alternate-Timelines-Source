...
import funkin.game.stages.FCRLimo;
import funkin.game.stages.FCRLimo2;
import funkin.game.stages.FCRLimo3;
import funkin.game.stages.WhiteBG;
...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'whitebg': new WhiteBG();
			case 'whitebg-echo': new WhiteBG();
			case 'limo-1': new FCRLimo();
			case 'limo-1-alt': new FCRLimo();
			case 'limo-2': new FCRLimo2();
			case 'limo-3': new FCRLimo3();
		}
	...
	override function sectionHit()
	{
		if (SONG.notes[curSection] != null)
		{
			...
			if (camZooming && FlxG.camera.zoom < 1.35 && curBeat % 8 == 0 && ClientPrefs.data.camZooms)
			{
